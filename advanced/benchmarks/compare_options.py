...
class BenchmarkRunner:
    ...
    def print_comparison(self) -> None:
        ...
        print("-" * 80)
        print(f"{'Average Gap (ms)':<30} {self.option_a_result.avg_gap_ms:>20.2f} {self.option_b_result.avg_gap_ms:>20.2f}")
        print(f"{'Min Gap (ms)':<30} {self.option_a_result.min_gap_ms:>20.2f} {self.option_b_result.min_gap_ms:>20.2f}")
        print(f"{'Max Gap (ms)':<30} {self.option_a_result.max_gap_ms:>20.2f} {self.option_b_result.max_gap_ms:>20.2f}")
        print(f"{'Std Dev (ms)':<30} {self.option_a_result.std_gap_ms:>20.2f} {self.option_b_result.std_gap_ms:>20.2f}")
        print("")
        ...
        print(f"{'Metric':<30} {'Option A':>20} {'Option B':>20}")
        print("-" * 80)
        print(f"{'Average CPU (%)':<30} {self.option_a_result.avg_cpu_percent:>20.2f} {self.option_b_result.avg_cpu_percent:>20.2f}")
        print(f"{'Max CPU (%)':<30} {self.option_a_result.max_cpu_percent:>20.2f} {self.option_b_result.max_cpu_percent:>20.2f}")
        print(f"{'Average Memory (MB)':<30} {self.option_a_result.avg_memory_mb:>20.2f} {self.option_b_result.avg_memory_mb:>20.2f}")
        print(f"{'Max Memory (MB)':<30} {self.option_a_result.max_memory_mb:>20.2f} {self.option_b_result.max_memory_mb:>20.2f}")
        print("")
        ...
        print(f"{'Metric':<30} {'Option A':>20} {'Option B':>20}")
        print("-" * 80)
        print(f"{'Successful Switches':<30} {self.option_a_result.switch_count:>20} {self.option_b_result.switch_count:>20}")
        print(f"{'Crash Count':<30} {self.option_a_result.crash_count:>20} {self.option_b_result.crash_count:>20}")
        print(f"{'Restart Count':<30} {self.option_a_result.restart_count:>20} {self.option_b_result.restart_count:>20}")
        print("")
        ...
        gap_improvement = ((self.option_b_result.avg_gap_ms - self.option_a_result.avg_gap_ms) / self.option_b_result.avg_gap_ms) * 100
